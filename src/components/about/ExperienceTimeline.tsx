        ...
        <div className="relative">
          ...
          <div className="relative grid grid-cols-3 gap-8">
            {sortedExperiences.map((experience, index) => (
              ...
              >
                <div className={`absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/3 w-4 h-4 bg-gradient-to-b from-${experience.color}-500 to-${experience.color}-400 rounded-full z-10`}>
                ...
                <div className="mt-8">
                  ...
                  >
                    <h3 className="text-lg font-bold text-gray-800 mb-3 leading-snug">{experience.title}</h3>

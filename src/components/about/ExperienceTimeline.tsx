    ...
    <div className="space-y-12 md:space-y-16">
      <div className="flex items-center justify-between mb-8 md:mb-12">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-800">경력 및 경험</h2>
        </div>
      </div>
            ...
            {sortedExperiences.map((experience, index) => (
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  <motion.div 
                    className="bg-white p-4 md:p-6 rounded-3xl border border-emerald-100 shadow-[8px_8px_16px_rgba(16,185,129,0.2),-8px_-8px_16px_#ffffff] hover:shadow-[inset_8px_8px_16px_rgba(16,185,129,0.15),inset_-8px_-8px_16px_#ffffff] group cursor-pointer transition-all duration-300"
                    whileHover={{ y: -2 }}
                    transition={{ type: "spring", stiffness: 400, damping: 20 }}
                  >
                    <h3 className="text-base md:text-lg font-bold text-emerald-800 mb-2 md:mb-3 leading-snug">{experience.title}</h3>
                    <p className="text-sm font-medium text-emerald-600 mb-2 leading-relaxed">{experience.role}</p>
                    <p className="text-xs md:text-sm text-gray-600 mb-3 md:mb-4 leading-relaxed tracking-wide">

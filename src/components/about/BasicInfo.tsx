...
const BasicInfo = () => {
  return (
    <div className="w-full grid grid-cols-12 gap-8">
      {/* Basic Info - 3/12 (25%) */}
      <motion.div 
        className="col-span-12 md:col-span-4 bg-white p-6 rounded-3xl shadow-[2px_2px_4px_#bebebe,-2px_-2px_4px_#ffffff]"
        whileHover={{ y: -3 }}
      ...
      >
        ...
        <div className="space-y-4 text-gray-700">
          <div className="bg-white p-4 rounded-xl shadow-[inset_2px_2px_4px_#bebebe,-2px_-2px_4px_#ffffff]">
      ...
      <motion.div 
        className="col-span-12 md:col-span-8 bg-white p-6 rounded-3xl shadow-[2px_2px_4px_#bebebe,-2px_-2px_4px_#ffffff]"
        whileHover={{ y: -3 }}
        transition={{ type: "spring", stiffness: 400, damping: 20 }}
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="w-1 h-5 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full"></div>
          <h2 className="text-xl font-semibold text-gray-800">자격증</h2>
        </div>
